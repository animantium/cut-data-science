...
latex_documents = [
    ('index',
     ...
     u"{{ cookiecutter.author_name }}", u"{{ cookiecutter.user_name }}", 'manual'),
]
...
man_pages = [
    ('index', '{{ cookiecutter.repo_name }}', u'{{ cookiecutter.project_name }} Documentation',
     [u"{{ cookiecutter.author_name }}"], u'{{ cookiecutter.user_name }}, 1)
]
...
texinfo_documents = [
    ('index', '{{ cookiecutter.repo_name }}', u'{{ cookiecutter.project_name }} Documentation',
     u"{{ cookiecutter.author_name }}", u'{{ cookiecutter.user_name }}', '{{ cookiecutter.project_name }}',
